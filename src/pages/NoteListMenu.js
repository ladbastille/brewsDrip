...
function NoteListMenu (){
    return(
        ...
        <HeaderH1 margintop={"20px"} color={"#ffffff"}>Taste Note</HeaderH1>
        <StyledTimerlistLink
          to="/newnote"
          background={"#B4CFCB"}
          color={"#FFFFFF"}
        ...
        <NotesTag to="/tastenotelist/collected" marginbottom={"3%"} color={"#FFFFFF"}>
          Collections
        </NotesTag>
        <NotesTag to="/tastenotelist/mynotes" marginbottom={"3%"} color={"#FFFFFF"}>
          My Notes
        </NotesTag>
        </NotesTagWrap>
        </>
