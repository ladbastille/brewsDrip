    ...
    <>
      <TutorialsBrewDiv>
        <CardListDiv>
          ...
          <CardListText>
          As Colby mentioned, one of the biggest similarities is the incredible diversity of beans and grapes. Not only do both have seemingly endless varieties, they have multiplicity in the way in which they are processed. The result is an inexhaustible range of flavors and styles.
          </CardListText>
          <FlexRowDiv>
            <CardListImg
              width={"48%"}
          ...
          <CardListH4>Bobby, how has learning about coffee has helped you in your career as a wine expert?</CardListH4>
          <CardListText>
          ...
          <CardListH4>What parallels do you see between coffee and wine from a tasting perspective?</CardListH4>
          <CardListText>
          ...
          <CardListText>When tasting coffees, you may hear descriptors of different types of stone fruits, aromatics of perhaps basil, maybe a sparkling minerality, a silky mouthfeel with a complex and lingering finish, and always the descriptions of sweetness, acidity and clarity. Even though there are lexicons and “norms”, tasting is ultimately a subjective endeavor and like wine, people will like and dislike individually whether it is because of the cultivar, the region, or the approach of the winemaker or coffeemaker themselves.</CardListText>
          
          

          <CardListH4>Speaking of tasting, what are the steps one should take when wine tasting at home?</CardListH4>
          <CardListText>
          ...
          <CardListH4>What are the steps one should take when choosing coffee beans to brew at home?</CardListH4>
          <CardListText>
          ...
          <CardListText>We at Verve roast lighter than many coffee companies because we want you to taste the intrinsic qualities of the coffee and not overwhelm and smother those unique, desirable qualities in roast. That said, we do have a range of roast profiles and coffee types to choose from - you may like balance and chocolate or you may like fruit-forward, the options are really endless.</CardListText>
          
          
          <CardListH4>Colby, what’s your favorite coffee offered on Verve right now and Bobby, what’s your favorite wine available on Winc?</CardListH4>
          <CardListText>
          ...
          <CardListH4>Bobby, how do you like your coffee and do you have any favorite types of coffee?</CardListH4>
          <CardListText>
          ...
          />
          <CardListH4>What’s your favorite word or term used to describe wine and coffee, respectively?</CardListH4>
          <CardListText>BD: “Sexy.”  It’s seldomly used by winemakers, but describes a red wine that is easy to drink, elegant, with velvety tannins and pretty aromas like flowers and fresh fruit. </CardListText>
